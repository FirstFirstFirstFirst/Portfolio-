    ...
    <div className='w-full lg:h-screen'>
        <div className='max-w-[1240] m-auto px-2 py-16 w-full'>
          ...
          <div className='grid lg:grid-cols-5 gap-8'>
            ...
            {/* right */}
            <div className='col-span-3 w-full h-auto shadow0xl shadow-gray-400 rounded-xl lg:p-4'>
              <div className='p-4'>
                <form action="">
                  ...
                  <div className='flex flex-col py-2'>
                    ...
                    <textarea className='border-2 rounde-lg p-3 border-gray-300' rows ='10'></textarea>
                  </div>
                  <div>
